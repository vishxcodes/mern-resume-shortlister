...
export default function CandidateResume() {
  ...
  // Safely extract filename from Cloudinary URL
  const fileName = resume?.resumeUrl
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white px-3 py-1.5 rounded flex items-center gap-2 transition-colors duration-200"
              >
